...
**प्रोजेक्ट पेट E-Cat** —— ट्रैकिंग रडार टोपी पहने और पार्सल थामे एक बिल्ली। एक ही स्वयंपूर्ण SVG वेक्टर फ़ाइल, जिसमें सांस लेने / पलक झपकाने / पूँछ हिलाने / रडार स्कैन एनिमेशन अंतर्निहित हैं और `prefers-reduced-motion` का समर्थन है। `docs/diagrams/mascot.svg` इस पात्र का एकमात्र स्रोत फ़ाइल है; इसे एडमिन इंस्टॉल विज़ार्ड (`/install`), 404 / 5xx त्रुटि पृष्ठों, Flutter एडमिन (लॉगिन पृष्ठ + वेब प्रथम-रेंडर लोडर), HarmonyOS क्लाइंट लॉगिन पृष्ठ, API दस्तावेज़ के कोने का बैज और साइट favicon में जोड़ा गया है।
...
<img src="diagrams/description.svg" alt="प्लेटफ़ॉर्म विशेषताएँ" width="100%">

- **एकीकृत ट्रैकिंग क्वेरी: एक ट्रैकिंग नंबर पूरी दुनिया में — 187 नंबर-पैटर्न नियम स्वचालित रूप से घरेलू/अंतरराष्ट्रीय चैनल और कैरियर पहचानते हैं, 209 कैरियर एडेप्टर `TrackStatus` की 7 मानक स्थितियों में आउटपुट एकीकृत करते हैं;**
- **मल्टी-कैरियर एकीकरण: 45 घरेलू + 164 अंतरराष्ट्रीय एडेप्टर, DHL / FedEx / UPS / USPS और राष्ट्रीय डाक S10 का पूर्ण कवरेज, क्रेडेंशियल एन्क्रिप्टेड, कोई हार्डकोडेड कुंजी नहीं;**
- **एडमिन RBAC: JWT + ब्लैकलिस्ट + method.path-स्तरीय अनुमतियाँ + पूर्ण ऑडिट ट्रेल, सुरक्षा फ़िल्टर XSS / SQL इंजेक्शन / CSRF / कमांड इंजेक्शन रोकता है;**
- **भुगतान क्लोज़्ड लूप: Stripe / PayPal + USDT TRC20 / BEP20 / ERC20, webhook हस्ताक्षर सत्यापन ऑर्डर स्वतः पुष्टि करता है, भुगतान विधियाँ कॉन्फ़िगरेशन से प्रभावी;**
- **क्लाइंट पोर्टल और प्लान: रजिस्टर / लॉगिन / ऐप प्रबंधन / प्लान / ऑर्डर API, X-API-Key क्लाइंट स्वयं सेट करता है, क्लाइंट JWT एडमिन से पूरी तरह अलग;**
- **API गेटवे सुरक्षा: API-Key प्रमाणीकरण, Redis रेट लिमिट (429), प्रति-कैरियर सर्किट ब्रेकर (503), SSRF सुरक्षा, हमले के पेलोड गेटवे पर ही रुकते हैं;**
- **CDN सुरक्षित वितरण: Cloudflare फ्री प्लान पूरी-साइट HTTPS + डबल WAF + एज कैश, Tunnel ओरिजिन बिना सार्वजनिक एक्सपोज़र;**
- **बहुभाषी SDK: Python / PHP / Node.js / Go / Rust के लिए पाँच ज़ीरो-डिपेंडेंसी SDK, कॉपी करके चलाएँ।**

## वन-क्लिक इंस्टॉल

अनुशंसित: Docker Compose से एक कमांड में डिप्लॉय — 5 सेवाएँ (Nginx / PHP / MySQL / Redis / Elasticsearch) हेल्थ चेक और डेटा स्थिरता के साथ शुरू होती हैं:

```bash
bash install.sh
```

रिपॉज़िटरी क्लोन करने के बाद:

```bash
cd integrated-global-logistics   # प्रोजेक्ट रूट में जाएँ
bash install.sh                  # डिफ़ॉल्ट पोर्ट 80, NGINX_PORT=8080 से बदला जा सकता है
```

स्क्रिप्ट Docker वातावरण की जाँच करती है, सभी सेवाएँ शुरू करती है और हेल्थ चेक पोल करती है (अधिकतम 120 सेकंड); तैयार होने पर `http://localhost/install` खोलकर इंस्टॉल विज़ार्ड पूरा करें (डेटाबेस इनिशियलाइज़ेशन + एडमिन निर्माण)। विस्तृत डिप्लॉयमेंट के लिए देखें [admin/README.md](../../admin/README.md)।
