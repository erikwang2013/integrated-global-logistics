...
प्रबंधन (ब्राउज़र) → `/admin/*`: JWT + RBAC अनुमतियाँ + ऑपरेशन ऑडिट, कवर करता है carrier / carrier-credential / tracking-query / callback-subscription / statistics।
