...
<img src="../../../docs/diagrams/description.svg" alt="قائمة الميزات" width="100%">
...
| إصدار PHP | 8.3+ | |
| قاعدة البيانات | MySQL 8.0+ | بادئة الجداول `logistics_`، مفتاح أساسي BIGINT غير تلقائي الزيادة |
