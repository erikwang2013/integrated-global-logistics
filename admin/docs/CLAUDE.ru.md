...
| Фирменный стиль | Талисман проекта E-Cat (мастер установки / страницы ошибок 404·5xx / страница входа / загрузчик первого рендера / угловой значок документации API) |
...
│   ├── model/                  # Модели данных
│   ├── exception/              # Глобальная обработка исключений (запросы браузера отдают страницу ошибки с талисманом)
