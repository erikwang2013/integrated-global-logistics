...
flowchart LR
    ...
    subgraph store["2. Stockage"]
        s1["Table MySQL logistics_*<br/>id BIGINT UNSIGNED NOT NULL"]
        s2["Champs sensibles cast encryptable<br/>Stockage chiffré AES-128-ECB"]
        g3 --> s1 --> s2
    end

    subgraph transfer["3. Transfert"]
