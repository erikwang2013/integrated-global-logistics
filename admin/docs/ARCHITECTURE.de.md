...
flowchart TB
    ...
    subgraph "Speicherebene"
        D1[("MySQL 8.0<br/>Hauptspeicher<br/>Tabellenpräfix logistics_")]
        D2[("Elasticsearch<br/>Volltextsuche<br/>Indexpräfix logistics_")]
...
flowchart TD
    ...
    subgraph "Ausnahmebehandlung (Exception Layer)"
        E1["app/exception/Handler<br/>Browser-Anfragen → Fehlerseite mit dem Projekttier<br/>API-Anfragen / Debug-Modus → Standardverhalten des Frameworks"]
    end
...
flowchart LR
    ...
    subgraph "2. Speicherung"
        S1["MySQL logistics_*-Tabellen<br/>id BIGINT UNSIGNED<br/>NOT NULL"]
...
flowchart TB
    ...
    subgraph "Datenebene"
        MYSQL["MySQL 8.0<br/>Master-Slave-Replikation<br/>logistics_-Präfix"]
        ES["Elasticsearch 8.x<br/>3-Knoten-Cluster<br/>logistics_-Präfix"]
