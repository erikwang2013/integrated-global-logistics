...
الهوية البصرية: تستخدم صفحة تسجيل الدخول ومحمّل أول عرض للويب حيوان المشروع الأليف E-Cat (`docs/diagrams/mascot.svg`، ملف SVG متحرك واحد مع دعم `prefers-reduced-motion`)
