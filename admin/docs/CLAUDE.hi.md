...
| ब्रांडिंग | प्रोजेक्ट पेट E-Cat (इंस्टॉल विज़ार्ड / 404·5xx त्रुटि पृष्ठ / लॉगिन पृष्ठ / प्रथम-रेंडर लोडर / API दस्तावेज़ बैज) |

## तकनीकी स्टैक

### बैकएंड
- PHP 8.3+, webman v2 (workerman/webman)
- डेटाबेस: MySQL 8.0+, टेबल प्रीफ़िक्स `logistics_`
...
│   ├── model/                  # डेटा मॉडल
│   ├── exception/              # वैश्विक अपवाद प्रबंधन (ब्राउज़र अनुरोधों पर पेट त्रुटि पृष्ठ)
│   ├── queue/                  # क्यू टास्क
