...
flowchart TD
    ...
    subgraph "Penanganan Eksepsi (Exception Layer)"
        E1["app/exception/Handler<br/>permintaan browser → halaman galat maskot<br/>permintaan API / mode debug → perilaku bawaan framework"]
    end
...
sequenceDiagram
    ...
    C->>N: Permintaan HTTPS<br/>Header: Accept-Language: zh_CN
    N->>MW_LOC: Teruskan
