...
| ব্র্যান্ডিং | প্রকল্পের মাস্কট E-Cat (ইনস্টল উইজার্ড / 404·5xx ত্রুটি পৃষ্ঠা / লগইন পৃষ্ঠা / প্রথম-রেন্ডার লোডার / API ডকুমেন্টেশন ব্যাজ) |
...
│   ├── model/                  # ডেটা মডেল
│   ├── exception/              # গ্লোবাল ব্যতিক্রম পরিচালনা (ব্রাউজার অনুরোধে মাস্কট ত্রুটি পৃষ্ঠা)
│   ├── queue/                  # কিউ টাস্ক
