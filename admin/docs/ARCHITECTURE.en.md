...
flowchart TB
    ...
    subgraph "Storage Layer"
        D1[("MySQL 8.0<br/>Primary Storage<br/>Table Prefix logistics_")]
        D2[("Elasticsearch<br/>Full-Text Search<br/>Index Prefix logistics_")]
...
flowchart TD
    ...
    subgraph "Exception Layer"
        E1["app/exception/Handler<br/>browser requests → project-pet error page<br/>API requests / debug mode → framework default behaviour"]
    end
...
flowchart LR
    ...
    subgraph "2. Storage"
        S1["MySQL logistics_* Tables<br/>id BIGINT UNSIGNED<br/>NOT NULL"]
